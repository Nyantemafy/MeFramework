...
public class Scanner {
    ...
    public void validateFields(Object model) throws ValidationException {
        ...
        for (Field field : fields) {
            ...
            try {
                ...
                throw new ValidationException("Erreur d'accès au champ : " + field.getName());
            }

            if (field.isAnnotationPresent(Required.class)) {
                if (value == null || (value instanceof String && ((String) value).trim().isEmpty())) {
                    throw new ValidationException("Le champ '" + field.getName() + "' est requis.");
                }
            }

            if (field.isAnnotationPresent(Email.class)) {
                if (value != null && value instanceof String && !((String) value).matches("^[A-Za-z0-9+_.-]+@(.+)$")) {
                    throw new ValidationException("Le champ '" + field.getName() + "' doit être un email valide.");
                }
            }
        }
    }
            ...
            System.out.println("Paramètre trouvé : " + parameterName);
                ...
                while (innerParameterNames.hasMoreElements()) {
                    ...
                    System.out.println("Attribut trouvé : " + attrib);
                        ...
                        System.out.println("Nom de l'attribut analysé : " + attrib);
                        System.out.println("Nom formaté pour le setter : " + formattedName);
                            ...
                            for (Method method : methods) {
                                if (method.getName().equalsIgnoreCase(setterMethodName)) {
                                    setterMethod = method;
                                    System.out.println("Méthode setter trouvée : " + setterMethod.getName());
                                    break;
                                }
                            }
